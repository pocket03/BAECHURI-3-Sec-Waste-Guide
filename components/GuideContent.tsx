  ...
  return (
    <main className="mx-auto max-w-md px-4 py-12 min-h-screen flex flex-col justify-center">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-neutral-500 mt-2 leading-relaxed">{t(lang, "chooseLanguageSubtitle")}</p>
      </div>
      <div className="grid grid-cols-2 gap-3">
        {LANGS.map((l) => (
          <button
            ...
            className="flex flex-col items-center gap-2 rounded-2xl border border-neutral-200 bg-white py-6 shadow-sm hover:border-green-500 hover:shadow-md transition-all"
          >
